...
RR_6060::RR_6060(uint8_t address) {
  MPU_addr = address;
...
void RR_6060::calibrate(uint16_t samples) {
...
void RR_6060::mahonyUpdate(float gx, float gy, float gz, float deltat) {
